...
const DoughnutChartForFat = () => {
  ...
  const goal = userInfo.fat;
  const consumed = useSelector(selectConsumedFatPerDay);
  ...
  if (warning) {
    notifyWarn(
      `Maximum fat consumption. If you continue to consume, you will not reach your goal`
    );
  }
